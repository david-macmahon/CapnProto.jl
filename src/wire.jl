...
"""
    pointer_type(p::WirePointer)::UInt64
...
"""
    pointer_offset(p::WirePointer)::Int64
...
"""
    struct_data_words(p::WirePointer)::UInt16
...
"""
    struct_ptr_count(p::WirePointer)::UInt16
...
"""
    list_element_count(p::WirePointer)::UInt32
...
"""
    list_element_size(p::WirePointer)::UInt64
...
"""
    far_is_double(p::WirePointer)::Bool
...
"""
    far_offset(p::WirePointer)::UInt32
...
"""
    far_segment_id(p::WirePointer)::UInt32
...
"""
    struct_pointer(offset::Int64, data_words::Integer, ptr_count::Integer)::WirePointer
...
"""
    list_pointer(offset::Int64, element_size::WirePointer, element_count::Integer)::WirePointer
...
"""
    far_pointer(offset::Integer, segment_id::Integer, double::Bool=false)::WirePointer
...
"""
    element_words(element_size::WirePointer, count::Integer)::Int
